...
// Generate chatDB array
let chatGroups = username_array.slice(-4).map(username => {
    return {
        avatar: `https://i.pravatar.cc/40?img=${getRandomNumber(1, 50)}`,
        name: username
    };
});
chatGroups.push({ avatar: "https://cdn.pixabay.com/photo/2020/05/29/13/26/icons-5235125_1280.png", name: "Group" });
